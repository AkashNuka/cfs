      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative h-[420px] sm:h-[520px] rounded-2xl overflow-hidden border border-white/10">
              <Image
                src="/stock/1583454110551-21f2fa2afe61.jpg"
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-4 right-2 sm:-right-4 md:right-8 bg-primary text-white px-4 sm:px-5 py-2.5 sm:py-3 rounded-lg shadow-2xl shadow-primary/20 max-w-[calc(100%-1rem)]">
              <p
          ...
          >
            <p className="text-primary font-semibold tracking-[0.14em] sm:tracking-[0.2em] uppercase text-xs sm:text-sm mb-3">
              Meet the Founder
            </p>
            <h2
              className="text-3xl sm:text-4xl md:text-5xl font-bold uppercase leading-tight text-white"
              style={{ fontFamily: "var(--font-oswald)" }}
            >
              Satish{" "}
            ...
            <p className="mt-5 sm:mt-6 text-[var(--color-muted)] leading-relaxed text-base sm:text-lg">
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              {highlights.map((stat) => (
                <div key={stat.label} className="text-center bg-[var(--color-surface)] rounded-lg py-4 px-3 border border-white/5">
                  ...
                  <p className="text-[var(--color-muted)] text-xs mt-1 leading-tight">{stat.label}</p>
                </div>
              ))}
            </div>
